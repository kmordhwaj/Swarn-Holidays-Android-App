...
import 'package:new_swarn_holidays/ecom/screens/edit_address/edit_address_screen.dart';
import 'package:new_swarn_holidays/ecom/screens/manage_addresses/components/address_short_details_card.dart';
import 'package:new_swarn_holidays/ecom/services/data_streams/addresses_stream.dart';
    ...
    if (confirmDeletion) {
      ...
      try {
        status = await UserDatabaseHelper()
            .deleteAddressForCurrentUser(uid: currentUserId, id: addressId);
        if (status == true) {
