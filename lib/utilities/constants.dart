...
const String user = 'userFeed';
const String usersFollowers = 'userFollowers';
const String userFollowing = 'userFollowing';
const String placeHolderImageRef = 'assets/images/user_placeholder.jpg';
